...
const bindingEntry = `${baseDir}/node_modules/@rsvelte/rolldown-binding-wasm32-wasi/rolldown-binding.wasi.cjs`;

if (!fs.existsSync(bindingEntry)) {
  const bindingPkg = `@rsvelte/rolldown-binding-wasm32-wasi@${version}`;
